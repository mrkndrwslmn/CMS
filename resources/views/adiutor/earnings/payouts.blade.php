...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Payout History</h1>
                <p class="text-sm text-gray-500 mt-1">View all your payout requests and their status</p>
            </div>
        ...
        @if($payouts->isEmpty())
            ...
            <div class="px-6 py-12 text-center">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">No Payout Requests Yet</h3>
                    <p class="text-gray-500 mb-6">You haven't submitted any payout requests.</p>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $payout->payout_number }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
