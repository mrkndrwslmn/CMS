...
<div class="max-w-8xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('adiutor.referrals.share') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary-600 text-white font-medium rounded-lg shadow-sm hover:bg-primary-700 transition-colors">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6">
            ...
            <div class="text-center mb-6">
                ...
                <div class="flex items-center justify-center gap-3 mb-6">
                    ...
                    <a href="{{ route('adiutor.referrals.share') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-colors">
                        <x-lucide-share-2 class="w-5 h-5" />
                        Share Link
                    </a>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('adiutor.referrals.share') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white text-sm font-medium rounded-lg hover:bg-primary-700 transition-colors">
                        <x-lucide-share-2 class="w-4 h-4" />
                        Share Your Code
                    </a>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('adiutor.referrals.history') }}" class="text-primary-600 hover:text-primary-700 text-sm font-medium inline-flex items-center gap-1">
                View All
