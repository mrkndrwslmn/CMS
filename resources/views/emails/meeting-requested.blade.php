...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #1F2937; max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="background: #3B82F6; padding: 40px 30px; text-align: center;">
        <h1 style="margin: 0; font-size: 24px; font-weight: 600; color: white; letter-spacing: -0.5px;">New Meeting Request</h1>
    </div>
    
    <!-- Main Content -->
    <div style="padding: 40px 30px;">
        <p style="margin: 0 0 30px 0; font-size: 15px; color: #4B5563; line-height: 1.7;">A client has requested a meeting for project <strong style="color: #1F2937;">"{{ $meeting->project->title }}"</strong>.</p>
        ...
        <div style="margin: 0 0 24px 0;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td style="padding: 8px 0 0 0; font-size: 14px; color: #6B7280;">
                            <strong style="color: #1F2937;">Requested Time:</strong>
                        </td>
            ...
            <div style="margin-top: 16px; background: #EFF6FF; border-left: 3px solid #3B82F6; padding: 16px 20px;">
                <p style="margin: 0 0 8px 0; font-size: 13px; font-weight: 600; color: #1E40AF;">Description</p>
                <p style="margin: 0; font-size: 14px; color: #4B5563; line-height: 1.7;">{{ $meeting->description }}</p>
            </div>
            @endif
        </div>
        ...
        <div style="text-align: center; margin: 32px 0 0 0; padding: 32px 0 0 0; border-top: 1px solid #E5E7EB;">
            <a href="{{ config('app.url') }}/admin/meetings/{{ $meeting->id }}" style="display: inline-block; background: #3B82F6; color: white; padding: 14px 32px; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 0;">Review Request</a>
        </div>
    </div>
