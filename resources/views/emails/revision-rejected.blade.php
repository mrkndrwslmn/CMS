...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #1F2937; max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="background: #3B82F6; padding: 40px 30px; text-align: center;">
        <h1 style="margin: 0 0 4px 0; font-size: 24px; font-weight: 600; color: white; letter-spacing: -0.5px;">Revision Feedback</h1>
        <p style="margin: 0; font-size: 14px; color: #DBEAFE; font-weight: 500;">Updates Needed</p>
    </div>
    
    <!-- Main Content -->
    <div style="padding: 40px 30px;">
        <p style="margin: 0 0 30px 0; font-size: 15px; color: #4B5563; line-height: 1.7;">Dear {{ $revision->project->client->fullName ?? $revision->project->client->full_name ?? 'Valued Client' }}, we've received feedback on your revision for <strong style="color: #1F2937;">"{{ $revision->project->project_name }}"</strong> that requires some adjustments.</p>
        ...
        <div style="margin: 0 0 24px 0;">
            ...
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; padding: 24px;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td colspan="2" style="padding: 16px 0; border-bottom: 1px solid #E5E7EB;">
                            <p style="margin: 0 0 6px 0; font-size: 12px; font-weight: 600; color: #6B7280; text-transform: uppercase; letter-spacing: 0.5px;">Feedback Date</p>
                            <p style="margin: 0; font-size: 14px; color: #1F2937; font-weight: 500;">{{ $revision->rejected_at->format('M d, Y') }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="padding: 16px 0 0 0;">
                            ...
                            <p style="margin: 0; font-size: 14px; color: #1F2937; font-weight: 500;">Needs Revision</p>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <!-- Feedback & Required Changes Section -->
        <div style="padding: 32px 0 0 0; border-top: 1px solid #E5E7EB;">
            <p style="margin: 0 0 20px 0; font-size: 13px; font-weight: 600; color: #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Feedback & Required Changes</p>
            
            @if($revision->rejection_reason)
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; padding: 20px 24px; margin: 0 0 20px 0;">
                <p style="margin: 0 0 12px 0; font-size: 13px; font-weight: 600; color: #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Detailed Feedback</p>
                <p style="margin: 0; font-size: 14px; color: #4B5563; line-height: 1.7; white-space: pre-line;">{{ $revision->rejection_reason }}</p>
            </div>
            @endif
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 0 0 20px 12px; vertical-align: top;">
                        <p style="margin: 0 0 4px 0; font-size: 14px; font-weight: 600; color: #1F2937;">Review the Feedback Carefully</p>
                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.6;">Understand the specific changes and improvements needed</p>
                    </td>
                </tr>
                <tr>
                    <td style="width: 36px; padding: 0 0 20px 0; vertical-align: top;">
                    ...
                    <td style="padding: 0 0 20px 12px; vertical-align: top;">
                        <p style="margin: 0 0 4px 0; font-size: 14px; font-weight: 600; color: #1F2937;">Submit Updated Revision</p>
                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.6;">Address the feedback points and resubmit your improved revision</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding: 0 0 0 12px; vertical-align: top;">
                        <p style="margin: 0 0 4px 0; font-size: 14px; font-weight: 600; color: #1F2937;">Discuss if Needed</p>
                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.6;">Contact us directly if you need any clarification on the feedback</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="text-align: center; margin: 32px 0; padding: 32px 0 0 0; border-top: 1px solid #E5E7EB;">
            <a href="{{ route('client.dashboard') }}" style="display: inline-block; background: #3B82F6; color: white; padding: 14px 32px; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 0;">View Project Details</a>
        </div>
        ...
        <div style="padding: 24px 0 0 0; border-top: 1px solid #E5E7EB;">
            ...
            <p style="margin: 0; font-size: 14px; color: #6B7280; line-height: 1.7;">We're committed to helping you achieve your vision. Use your project dashboard to communicate directly with your team or reply to this email with any questions about the feedback.</p>
        </div>
        ...
        <div style="padding: 24px 0 0 0; border-top: 1px solid #E5E7EB; text-align: center;">
            ...
            <p style="margin: 0; font-size: 12px; color: #6B7280; line-height: 1.6;">Revision feedback notification for {{ $revision->project->client->fullName ?? $revision->project->client->full_name ?? 'Client' }}. We're committed to delivering excellence with your feedback.</p>
        </div>
    </div>
