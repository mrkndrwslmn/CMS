...
<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #1F2937; max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="background: #3B82F6; padding: 40px 30px; text-align: center;">
        <h1 style="margin: 0; font-size: 24px; font-weight: 600; color: white; letter-spacing: -0.5px;">Milestone Completed</h1>
    </div>
    
    <!-- Main Content -->
    <div style="padding: 40px 30px;">
        <p style="margin: 0 0 30px 0; font-size: 15px; color: #4B5563; line-height: 1.7;">We've successfully completed <strong style="color: #1F2937;">"{{ $milestone->title }}"</strong> for your project.</p>
        
        <!-- Completion Details Section -->
        <div style="margin: 0 0 24px 0;">
            <p style="margin: 0 0 16px 0; font-size: 13px; font-weight: 600; color: #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Completion Details</p>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td colspan="2" style="padding: 16px 0; border-bottom: 1px solid #E5E7EB;">
                            ...
                            <p style="margin: 0; font-size: 14px; color: #1F2937; font-weight: 500;">{{ $milestone->completed_at->format('M d, Y') }}</p>
                        </td>
                    </tr>
                    @if($milestone->due_date)
                    <tr>
                        <td colspan="2" style="padding: 16px 0; border-bottom: 1px solid #E5E7EB;">
                            <p style="margin: 0 0 6px 0; font-size: 12px; font-weight: 600; color: #6B7280; text-transform: uppercase; letter-spacing: 0.5px;">Timeline Status</p>
                    ...
                    <tr>
                        <td colspan="2" style="padding: 16px 0 0 0;">
                            ...
                            <p style="margin: 0; font-size: 14px; color: #1F2937; font-weight: 500;">Completed</p>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="margin-top: 16px; background: #EFF6FF; border-left: 3px solid #3B82F6; padding: 16px 20px;">
                <p style="margin: 0; font-size: 14px; color: #4B5563; line-height: 1.7; white-space: pre-line;">{{ $milestone->completion_notes }}</p>
            </div>
            @endif
            ...
            <div style="margin-top: 16px; background: #F0FDF4; border-left: 3px solid #10B981; padding: 16px 20px;">
                <p style="margin: 0 0 8px 0; font-size: 13px; font-weight: 600; color: #065F46;">Delivered Items</p>
        ...
        <div style="text-align: center; margin: 0 0 32px 0;">
            <a href="{{ route('client.milestones.show', $milestone->id) }}" style="display: inline-block; background: #3B82F6; color: white; padding: 14px 32px; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 0;">Review Deliverables</a>
        </div>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 0 0 20px 12px; vertical-align: top;">
                        ...
                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.6;">Access and review all completed deliverables in your dashboard</p>
                    </td>
                </tr>
                <tr>
                    <td style="width: 36px; padding: 0 0 20px 0; vertical-align: top;">
                    ...
                    <td style="padding: 0 0 20px 12px; vertical-align: top;">
                        ...
                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.6;">Share your feedback and any necessary adjustments</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding: 0 0 0 12px; vertical-align: top;">
                        <p style="margin: 0 0 4px 0; font-size: 14px; font-weight: 600; color: #1F2937;">Move Forward</p>
                        <p style="margin: 0; font-size: 13px; color: #6B7280; line-height: 1.6;">We're ready to proceed to the next phase of your project</p>
                    </td>
                </tr>
            </table>
        </div>
