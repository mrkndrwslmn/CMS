                    ...
                    <tr>
                        <td style="padding: 40px 40px 32px;">
                            ...
                            <p style="margin: 0; font-size: 15px; color: #64748B; line-height: 1.6;">
                                We've successfully completed <strong style="color: #0F172A;">"{{ $milestone->title }}"</strong> for your project.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 32px 40px;">
                            ...
                            <div style="margin-top: 16px; padding: 12px 16px; background-color: #F0FDF4; border-left: 3px solid #16A34A; border-radius: 4px;">
                                <p style="margin: 0; font-size: 13px; font-weight: 500; color: #0F172A; margin-bottom: 8px;">Delivered Items:</p>
                                <p style="margin: 0; font-size: 14px; color: #334155; line-height: 1.5; white-space: pre-line;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    ...
                                    <td style="padding: 0 0 16px 12px; vertical-align: top;">
                                        ...
                                        <div style="font-size: 13px; color: #64748B; line-height: 1.5;">Access and review all completed deliverables in your dashboard</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 0 16px 0; vertical-align: top; width: 24px;">
                                    ...
                                    <td style="padding: 0 0 16px 12px; vertical-align: top;">
                                        ...
                                        <div style="font-size: 13px; color: #64748B; line-height: 1.5;">Share your feedback and any necessary adjustments</div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding: 0 0 0 12px; vertical-align: top;">
                                        <div style="font-size: 14px; font-weight: 500; color: #0F172A; margin-bottom: 2px;">Move Forward</div>
                                        <div style="font-size: 13px; color: #64748B; line-height: 1.5;">We're ready to proceed to the next phase of your project</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
