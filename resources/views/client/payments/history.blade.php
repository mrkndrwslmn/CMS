    ...
    <div class="bg-white/80 backdrop-blur-sm border-b border-neutral-200/60">
        <div class="max-w-7xl mx-auto px-6 py-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-neutral-900 mb-1">Payment History</h1>
                    <p class="text-neutral-600 text-sm">Track your payment transactions and invoices</p>
                </div>
            </div>
        </div>
    </div>
