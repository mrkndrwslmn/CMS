        ...
        <div class="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Max Hour for Task -->
                    <div>
                        <label for="max_hours" class="block text-sm font-semibold text-neutral-700 mb-2">
                            Max Hour for Task
                        </label>
                        <div class="relative">
                            <input type="number" name="max_hours" id="max_hours" step="0.5" min="0"
                                   class="w-full rounded-lg border-2 border-neutral-300 px-4 py-3 text-neutral-900 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all @error('max_hours') border-error-500 @enderror"
                                   value="{{ old('max_hours') }}" placeholder="0.0">
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500 text-sm">hours</span>
                        </div>
                        @error('max_hours')
                            <p class="text-error-500 text-sm mt-2 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i> {{ $message }}
                    ...
                    <!-- Starting Date -->
                    <div>
                        <label for="starting_date" class="block text-sm font-semibold text-neutral-700 mb-2">
                            Starting Date
                        </label>
                        <input type="date" name="starting_date" id="starting_date" 
                               class="w-full rounded-lg border-2 border-neutral-300 px-4 py-3 text-neutral-900 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition-all @error('starting_date') border-error-500 @enderror"
