...
<div class="px-6 py-8">
    ...
    <nav class="mb-6" aria-label="Breadcrumb">
        <ol class="flex items-center gap-2 text-sm">
            ...
            <li>
                <a href="{{ route('admin.coupons.show', $coupon) }}" class="text-neutral-600 hover:text-primary-600 transition-colors">
                    {{ $coupon->code }}
                </a>
            </li>
            <li>
            ...
            <li class="text-neutral-900 font-medium">Edit</li>
        </ol>
    </nav>
    ...
    <div class="mb-8">
        ...
        <p class="text-neutral-500 mt-2">Update coupon details and settings</p>
    </div>
