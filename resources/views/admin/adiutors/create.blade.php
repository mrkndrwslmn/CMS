...
<div class="p-6 lg:p-8">
    ...
    <x-ui.breadcrumb :items="[
        ...
        ['label' => 'Add New Adiutor', 'icon' => 'user-plus'],
    ]" class="mb-6" />

    <!-- Page Header -->
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <x-ui.page-header 
            title="Add New Adiutor" 
            description="Create a new adiutor account"
        />
    ...
    <x-ui.card>
        ...
        <div class="p-6">
            <form action="{{ route('admin.adiutors.store') }}" method="POST">
                @csrf
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-info-700">
                                For security and privacy purposes, a secure password will be automatically generated and sent to the adiutor's email address along with login instructions.
                            </p>
                        </div>
                    </div>
                </div>
