...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => 'Payment Management','description' => 'Track and manage all payments']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Payment Management','description' => 'Track and manage all payments']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'p-6']); ?>
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-neutral-800 mt-1"><?php echo e($stats['total']); ?></p>
                </div>
...
<?php $component->withAttributes(['class' => 'p-6']); ?>
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-warning-600 mt-1"><?php echo e($stats['pending']); ?></p>
                    <p class="text-xs text-neutral-400 mt-1">₱<?php echo e(number_format($stats['pending_amount'], 2)); ?></p>
                </div>
...
<?php $component->withAttributes(['class' => 'p-6']); ?>
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-success-600 mt-1"><?php echo e($stats['confirmed']); ?></p>
                </div>
...
<?php $component->withAttributes(['class' => 'p-6']); ?>
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-2xl font-semibold text-success-600 mt-1">₱<?php echo e(number_format($stats['total_revenue'], 2)); ?></p>
                </div>
                <div class="p-3 bg-success-50 rounded-xl">
                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['class' => 'p-6 mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'p-6 mb-6']); ?>
        <form method="GET" action="<?php echo e(route('admin.payments.index')); ?>" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="payment_method" class="w-full px-3 py-2 border border-neutral-200 rounded-lg text-sm focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-colors">
                        ...
                        <option value="maya" <?php echo e(request('payment_method') == 'maya' ? 'selected' : ''); ?>>Maya</option>
                ...
                <tbody class="divide-y divide-neutral-100">
                    ...
                    <tr class="hover:bg-neutral-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-neutral-800"><?php echo e($payment->serviceRequest->project_name ?? 'N/A'); ?></div>
                            <div class="text-xs text-neutral-400">Request #<?php echo e($payment->service_request_id); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-neutral-700"><?php echo e($payment->payment_reference); ?></div>
                            <?php if($payment->transaction_id): ?>
                            <div class="text-xs text-neutral-400">TXN: <?php echo e($payment->transaction_id); ?></div>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">
                            <span class="capitalize"><?php echo e(str_replace('_', ' ', $payment->payment_method)); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                <?php if($payment->status == 'confirmed'): ?> bg-success-100 text-success-700
                                <?php elseif($payment->status == 'pending'): ?> bg-warning-100 text-warning-700
                                <?php elseif($payment->status == 'failed'): ?> bg-error-100 text-error-700
                                <?php elseif($payment->status == 'refunded'): ?> bg-primary-100 text-primary-700
                                <?php else: ?> bg-neutral-100 text-neutral-600
                                <?php endif; ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-500">
                            ...
                            <div class="text-xs text-neutral-400"><?php echo e($payment->created_at->format('h:i A')); ?></div>
                        </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.pagination','data' => ['paginator' => $payments]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marka\Projects\cms\resources\views/admin/payments/index.blade.php ENDPATH**/ ?>