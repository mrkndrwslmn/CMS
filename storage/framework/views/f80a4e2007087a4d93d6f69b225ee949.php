<?php $__env->startSection('title', 'Calendar Management'); ?>
<?php $__env->startSection('page-title', 'Calendar Management'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => 'Calendar Management','description' => 'View and manage project schedules and assigned adiutors','class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Calendar Management','description' => 'View and manage project schedules and assigned adiutors','class' => 'mb-6']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <h3 class="font-semibold text-lg text-neutral-800"><?php echo e($project['project_name']); ?></h3>
...
<?php endif; ?>
                                Client: <span class="font-medium text-neutral-800"><?php echo e($project['client_name']); ?></span>
                            </p>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <?php $__currentLoopData = $project['adiutors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adiutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center bg-neutral-50 rounded-xl px-4 py-2.5 border border-neutral-100">
                                        <img src="<?php echo e($adiutor['avatar']); ?>" alt="<?php echo e($adiutor['name']); ?>" class="w-8 h-8 rounded-full object-cover mr-3">
                                        <div>
                                            <p class="text-sm font-medium text-neutral-800"><?php echo e($adiutor['name']); ?></p>
...
<?php endif; ?>
                                        ...
                                        <button onclick="viewAdiutorSchedule(<?php echo e($adiutor['id']); ?>, '<?php echo e($adiutor['name']); ?>')" 
...
<?php endif; ?>
                    ...
                    <div class="flex gap-3 pt-4 border-t border-neutral-100">
                        <a href="<?php echo e(route('admin.projects.schedule', $project['id'])); ?>">
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['icon' => 'calendar-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('admin.projects.show', $project['id'])); ?>">
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['variant' => 'secondary','icon' => 'eye']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','icon' => 'eye']); ?>
                                View Project Details
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.empty-state','data' => ['icon' => 'folder-kanban','title' => 'No Active Projects','description' => 'There are no active or in-progress projects to display.','class' => 'py-12']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'folder-kanban','title' => 'No Active Projects','description' => 'There are no active or in-progress projects to display.','class' => 'py-12']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marka\Projects\cms\resources\views/admin/calendar/index.blade.php ENDPATH**/ ?>