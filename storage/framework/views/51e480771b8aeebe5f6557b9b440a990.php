...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-neutral-300 animate-spin mx-auto']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('lucide-bell-off'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php endif; ?>
        ...
        <div class="px-4 py-3 border-t border-neutral-100">
            <a href="<?php echo e(route(auth()->user()->role . '.notifications.index')); ?>" 
...
function notificationBell() {
    return {
        ...
        async fetchNotifications() {
            this.isLoading = true;
            try {
                const response = await fetch('<?php echo e(route("notifications.fetch")); ?>', {
                    headers: {
        ...
        async markAsRead(notificationId) {
            try {
                await fetch(`<?php echo e(url('/notifications')); ?>/${notificationId}/read`, {
                    method: 'POST',
                    headers: {
...
<?php /**PATH C:\Users\marka\Projects\cms\resources\views/components/notification-bell.blade.php ENDPATH**/ ?>